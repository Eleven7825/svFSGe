...
class svFSI(Simulation):
    ...
    def set_solid(self, n, t):
        ...
        # Initialize homeostatic normalized WSS gradient (tauo) at first timestep
        # This ensures tauo matches the new normalized gradient values
        if t == 0 and n == 0:
            props[:, 3] = norm_wss_grad  # Set tauo = tau at prestress
